...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(reportFactory.resolveTxtPath()))) {
            ...
            writer.write("COMPLEXIDADE DE CADA MÉTODO: (NOTAÇÃO BIG O)");
            writer.write("\n\n");
            ...
            writer.write("-> Os métodos (1) e (2) são O(n) pois o número de repetições depende diretamente da quantidade de linhas do arquivo CSV.\n\n");
            writer.write("-> O método (3) é O(1) pois tanto o número de subestações como o número de meses são fixos e, portanto, não depende da quantidade de linhas do arquivo CSV.\n\n");
